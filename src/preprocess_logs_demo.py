...
DATA_DIR = Path("../data")
LATEST_LOGS_FILE = str(DATA_DIR / "validation_dataset.json")
...
def prepare_data_for_model(df):
    ...
    # FILL MISSING COLUMNS WITH DEFAULTS (Adjust as needed for your real-world data)
    safe_fill = {
...
if __name__ == "__main__":
    ...
    try:
        ...
        df_processed.to_json("../data/evaluated_logs_with_features_demo.json", orient="records", indent=2)
